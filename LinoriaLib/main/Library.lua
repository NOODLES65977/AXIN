...
local Library = {
    ...
    MainColor = Color3.fromRGB(24, 24, 27); -- 深色背景
    BackgroundColor = Color3.fromRGB(18, 18, 18); -- 侧边栏/底色背景

    AccentColor = Color3.fromRGB(139, 92, 246); -- 丁香紫 (比原来的蓝色更现代)
    DisabledAccentColor = Color3.fromRGB(63, 63, 70);

    OutlineColor = Color3.fromRGB(39, 39, 42); -- 边框线
    DisabledOutlineColor = Color3.fromRGB(30, 30, 33);

    DisabledTextColor = Color3.fromRGB(113, 113, 122);
    RiskColor = Color3.fromRGB(255, 70, 70);

    Black = Color3.new(0, 0, 0);
    Font = Enum.Font.BuilderSansMedium; -- 现代无衬线字体
